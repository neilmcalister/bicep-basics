...
$resourcegroup = 'rg-bicep-nomodules'
$location = 'uksouth'

az group create --name $resourcegroup --location $location

az deployment group what-if --resource-group $resourcegroup --template-file .\mssa-nomodules.bicep
az deployment group create --resource-group $resourcegroup --template-file .\mssa-nomodules.bicep
